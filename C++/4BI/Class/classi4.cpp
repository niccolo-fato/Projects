...
public:
    ...
    void new_address(string search_surname, string change_address)
    {
        ...
        if (!verify)
            cout << "ERROR==>Studente non trovato\n";
        if (verify)
        {
    ...
    void votes_file(string search_surname)
    {
        materia v;
        ifstream cin;
        cin.open("votes.txt");
...
int main()
{
    ...
    do
    {
        ...
        cout << "1-Per inserire uno studente,\n"
                ...
                "4-Per mettere voti ad uno studente da file, \n"
                "5-Per stampare\n"
                "0-Per uscire.\n"
                "Scelta:";
        cin >> choice;
        ...
        case 3:
            ...
            break;
        case 4:
            cout << "Inserisci il cognome al quale inserire i voti da un file:";
            cin >> search_surname;
            st.votes_file(search_surname);
            cout << "============================================\n";
            break;
        case 5:
            st.print();
